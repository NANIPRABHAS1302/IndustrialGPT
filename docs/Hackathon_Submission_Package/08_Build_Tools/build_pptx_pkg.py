...
def create_presentation_pptx():
    ...
    output_path = os.path.join(pkg_dir, "03_Presentation", "IndustrialGPT_Presentation.pptx")
    ...
    slides_data = [
        ...
        },
        {
            ...
            "image": os.path.join(pkg_dir, "05_Diagrams", "system_architecture.png"),
            "bullets": [
        ...
        },
        {
            ...
            "image": os.path.join(pkg_dir, "05_Diagrams", "ai_pipeline.png"),
            "bullets": [
        ...
        },
        {
            ...
            "image": os.path.join(pkg_dir, "05_Diagrams", "knowledge_graph_workflow.png"),
            "bullets": [
        ...
        },
        {
            ...
            "image": os.path.join(pkg_dir, "06_Screenshots", "02_dashboard.png"),
            "type": "screenshot"
        },
        {
            "title": "9. Grounded RAG AI Assistant Showcase",
            "image": os.path.join(pkg_dir, "06_Screenshots", "03_ai_chat.png"),
            "type": "screenshot"
        },
        {
            "title": "10. Neo4j Knowledge Graph Showcase",
            "image": os.path.join(pkg_dir, "06_Screenshots", "05_knowledge_graph.png"),
            "type": "screenshot"
        },
        {
            "title": "11. Predictive Maintenance Showcase",
            "image": os.path.join(pkg_dir, "06_Screenshots", "06_predictive_maintenance.png"),
            "type": "screenshot"
        },
        {
