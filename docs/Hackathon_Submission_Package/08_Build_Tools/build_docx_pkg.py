...
def create_project_report_docx():
    ...
    report_md_path = os.path.join(pkg_dir, "01_Project_Report", "Project_Report.md")
    output_path = os.path.join(pkg_dir, "01_Project_Report", "Project_Report.docx")
        ...
        for line in lines:
            ...
            if line_str.startswith("# "):
                ...
                try:
                    ...
                    img_full = os.path.normpath(os.path.join(pkg_dir, "01_Project_Report", img_rel))
